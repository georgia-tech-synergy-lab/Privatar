...
project_name = f"analyse_l2norm_bdct_hp_ibdct_decoder_{num_freq_comp_offloaded}"
result_path = f"{path_to_privatar}/testing_results/{project_name}"
framelist_test = f"{path_to_privatar}/experiment_scripts/test_segment.json"
camera_configs_path = f"{path_to_privatar}/multiface/camera_configs/camera-split-config_6795937.json"

...
def main(args, camera_config, test_segment):
    ...
    model = DeepAppearanceVAEBDCT(
        args.tex_size, args.mesh_inp_size, n_latent=args.nlatent, n_cams=n_cams, num_freq_comp_outsourced=args.num_freq_comp_outsourced
    ).to(device)
    ...
    if args.model_ckpt is not None:
        ...
        # model.enc.fc.load_state_dict(torch.load(args.model_ckpt, map_location=map_location).module.enc.fc)
        # model.dec.load_state_dict(torch.load(args.model_ckpt, map_location=map_location).module.dec)
        # model.cc.load_state_dict(torch.load(args.model_ckpt, map_location=map_location).module.cc)

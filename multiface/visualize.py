...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/work/dataset/m--20180227--0000--6795937--GHS', help='Directory to dataset root')
    parser.add_argument('--krt_dir', type=str, default='/work/dataset/m--20180227--0000--6795937--GHS/KRT', help='Directory to KRT file')
    parser.add_argument('--loss_weight_mask', type=str, default='./loss_weight_mask.png', help='Mask for weighted loss of face')
    parser.add_argument('--framelist_test', type=str, default='/work/dataset/m--20180227--0000--6795937--GHS/frame_list.txt', help='Frame list for testing')
    parser.add_argument('--test_segment_config', type=str, default='/work/experiment_scripts/test_segment.json', help='Directory of expression segments for visualization')
    ...
    parser.add_argument('--max_iter', type=int, default=10000, help='Maximum number of training iterations, overrides epoch')

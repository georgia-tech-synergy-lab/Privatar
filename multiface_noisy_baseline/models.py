...
class DeepAppearanceVAE(nn.Module):
    def __init__(
        ...
        if apply_gaussian_noise:
            ...
            # self.variance_matrix_tensor = torch.load("/home/jianming/work/Privatar_prj/profiled_latent_code/statistics/noise_variance_matrix_horizontal_partition_0_mutual_bound_1.pth").cpu()
    ...
    def forward(self, avgtex, mesh, view, cams=None):
        ...
        if self.apply_gaussian_noise:
            ...
            samples = torch.from_numpy(np.random.multivariate_normal(self.mean, self.variance_matrix_tensor.detach().numpy(), z.shape[0]))

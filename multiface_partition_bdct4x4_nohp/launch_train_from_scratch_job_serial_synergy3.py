...
path_prefix_uwing2 = "/usr/scratch/jianming/multiface/"
...
path_variance_matrix_tensor = "/usr/scratch/jianming/Privatar/testing_results/dummy_path"
prefix_path_captured_latent_code = ""
#######

average_texture_path = path_prefix + average_texture_path
BDCT_threshold = [5]# [0.1, 0.3, 0.305, 0.35, 0.4, 0.42, 0.45, 0.5, 0.6, 0.63, 0.7, 1.035, 1.1, 1.2, 3.5, 5]

...
path_testing_latent_code_god2 = "/home/jianming/work/Privatar_prj/testing_results/remove_upsample_horizontal_partition_"
path_testing_latent_code_synergy3 = "/usr/scratch/jianming/Privatar/testing_results/remove_upsample_horizontal_partition_"
...
path_variance_matrix_tensor = "/home/jianming/work/Privatar_prj/testing_results/dummy_path"
#######
...
for BDCT_thres in BDCT_threshold:
    ...
    print(f'torchrun --nproc_per_node=1 --master_port=25678  test.py --data_dir {path_prefix}/dataset/m--20180227--0000--6795937--GHS --krt_dir {path_prefix}/dataset/m--20180227--0000--6795937--GHS/KRT --framelist_test {path_prefix}/dataset/m--20180227--0000--6795937--GHS/frame_list.txt  --result_path {result_path} --test_segment "./test_segment.json" --lambda_screen 1 --model_path "/home/jianming/work/Privatar_prj/training_results/remove_upsample_horizontal_partition_{BDCT_thres}/best_model.pth" --frequency_threshold {BDCT_thres} --project_name hp_testing_no_upsample --author_name jimmytong --arch base --average_texture_path {path_prefix}{average_texture_path} --prefix_path_captured_latent_code {path_testing_latent_code} --save_latent_code_to_external_device --path_variance_matrix_tensor {path_variance_matrix_tensor}')

...
for BDCT_thres in BDCT_threshold:
    ...
    print(f'python3 test_uwing2.py --data_dir {path_prefix}/dataset/m--20180227--0000--6795937--GHS --krt_dir {path_prefix}/dataset/m--20180227--0000--6795937--GHS/KRT --framelist_test {path_prefix}/dataset/m--20180227--0000--6795937--GHS/frame_list.txt  --result_path {result_path} --test_segment "./test_segment.json" --lambda_screen 1 --model_path "{pretrain_model_path_prefix}{BDCT_thres}/best_model.pth" --frequency_threshold {BDCT_thres} --arch base --average_texture_path {path_prefix}{average_texture_path} --prefix_path_captured_latent_code {path_testing_latent_code} --apply_gaussian_noise False --save_latent_code_to_external_device True')

...
for BDCT_thres in BDCT_threshold:
    ...
    print(f'torchrun --nproc_per_node=1 --master_port=25679 train.py --data_dir {path_prefix}dataset/m--20180227--0000--6795937--GHS --krt_dir {path_prefix}dataset/m--20180227--0000--6795937--GHS/KRT --framelist_train {path_prefix}dataset/m--20180227--0000--6795937--GHS/frame_list.txt --framelist_test {path_prefix}dataset/m--20180227--0000--6795937--GHS/frame_list.txt --average_texture_path {path_prefix}dataset/m--20180227--0000--6795937--GHS/unwrapped_uv_1024/E001_Neutral_Eyes_Open/average/000102.png --result_path {result_path} --test_segment "./test_segment.json" --lambda_screen 1 --model_ckpt "{path_prefix}pretrained_model/6795937_best_base_model.pth" --arch base --frequency_threshold {BDCT_thres} --project_name chnl_sparsity --author_name jimmytong --apply_gaussian_noise False --save_latent_code_to_external_device False')

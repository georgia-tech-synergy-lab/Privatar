...
for BDCT_thres in BDCT_threshold:
    ...
    print(f'CUDA_VISIBLE_DEVICES=1 torchrun --nproc_per_node=1 --master_port=25680 train.py --data_dir {path_prefix}dataset/m--20180227--0000--6795937--GHS --krt_dir {path_prefix}dataset/m--20180227--0000--6795937--GHS/KRT --framelist_train {path_prefix}dataset/m--20180227--0000--6795937--GHS/frame_list.txt --framelist_test {path_prefix}dataset/m--20180227--0000--6795937--GHS/frame_list.txt --average_texture_path {path_prefix}dataset/m--20180227--0000--6795937--GHS/unwrapped_uv_1024/E001_Neutral_Eyes_Open/average/000102.png --result_path {result_path} --test_segment "./test_segment.json" --lambda_screen 1 --model_ckpt "{pretrain_model_path_prefix}{str(BDCT_thres)}/best_model.pth" --arch base --frequency_threshold {BDCT_thres} --project_name noisy_hp --author_name jimmytong --prefix_path_captured_latent_code {prefix_path_captured_latent_code} --apply_gaussian_noise True --save_latent_code_to_external_device False --path_variance_matrix_tensor {path_variance_matrix_tensor}')
    os.system(f'CUDA_VISIBLE_DEVICES=1 torchrun --nproc_per_node=1 --master_port=25680 train.py --data_dir {path_prefix}dataset/m--20180227--0000--6795937--GHS --krt_dir {path_prefix}dataset/m--20180227--0000--6795937--GHS/KRT --framelist_train {path_prefix}dataset/m--20180227--0000--6795937--GHS/frame_list.txt --framelist_test {path_prefix}dataset/m--20180227--0000--6795937--GHS/frame_list.txt --average_texture_path {path_prefix}dataset/m--20180227--0000--6795937--GHS/unwrapped_uv_1024/E001_Neutral_Eyes_Open/average/000102.png --result_path {result_path} --test_segment "./test_segment.json" --lambda_screen 1 --model_ckpt "{pretrain_model_path_prefix}{str(BDCT_thres)}/best_model.pth" --arch base --frequency_threshold {str(BDCT_thres)} --project_name noisy_hp --author_name jimmytong --prefix_path_captured_latent_code {prefix_path_captured_latent_code} --apply_gaussian_noise True --save_latent_code_to_external_device False --path_variance_matrix_tensor {path_variance_matrix_tensor}')
